...
class ShopifyAuth with ShopifyError {
  ...
  Future<ShopifyUser> createUserWithEmailAndPassword({
    ...
    LocalDatabase.to.box.write("customerAccessToken", customerAccessToken);
    print("access token on api side: $customerAccessToken");
    //----- LocaDtabase.to.box.write("acccestoken" :, customerAccessToken);
