...
import '../../graphql_operations/storefront/queries/get_filtered_x_products_after_cursor_within_collection.dart';
import './../../enums/enums.dart';
import './../../enums/src/sort_key_collection.dart';
...
import './../../graphql_operations/storefront/queries/get_metafileds_from_product.dart';
...
import './../../graphql_operations/storefront/queries/get_x_products_after_cursor.dart';
...
import './../../models/src/collection/collections/collections.dart';
import './../../models/src/product/metafield/metafield.dart';
import './../../models/src/product/product.dart';
import './../../models/src/product/products/products.dart';
import './../../models/src/shop/shop.dart';
...
class ShopifyStore with ShopifyError {
  ...
  /// Returns the first [limit] Products after the given [startCursor].
  /// [limit] has to be in the range of 0 and 250.
  Future<List<Product>?> getFilteredXProductsAfterCursorWithinCollection(
      String id, int limit, dynamic filters,
      {String? startCursor,
        SortKeyProductCollection sortKey = SortKeyProductCollection.BEST_SELLING,
        bool reverse = false}) async {
    String? cursor = startCursor;
    ...
    final WatchQueryOptions _options = WatchQueryOptions(
        document: gql(getFilteredXProductsAfterCursorWithinCollectionQuery),
        variables: {
          'id': id,
          'cursor': cursor,
          'limit': limit,
