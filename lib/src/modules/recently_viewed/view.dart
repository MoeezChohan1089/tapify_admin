...
class RecentlyViewedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<RecentlyViewedLogic>(builder: (logic) {
        return logic.userRecentlyViewed.isNotEmpty
            ? GridView(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2,
                  childAspectRatio:
                      AppConfig.to.customizationProductImage["chooseImage"] ==
                              "square"
                          ? 0.80
                          : 0.55,
                ...
                children:
                    List.generate(logic.userRecentlyViewed.length, (index) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Discover more, see more, and experience more.",
