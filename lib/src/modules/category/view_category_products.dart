...
import '../search/components/sort_options_sheet.dart';
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    logic.selectedFilters.isNotEmpty ? Row(
                                      children: [
                                        Container(
                                          width: 20,
                                          height: 20,
                    ...
                    child: SmartRefresher(
                          ...
                          builder: (BuildContext context, LoadStatus? mode) {
                            ...
                            if (mode == LoadStatus.idle) {
                              body = (logic.productsFetch.value.length !=
                                  logic.productsFetch.value.length) ? Text(
                                  logic.showFilteredProducts.isTrue
                                      ? ""
                                      : "Pull Up to Load More") : Text(
                                  logic.showFilteredProducts.isTrue
                                      ? ""
                                      : "No more products");
                            }
                      ...
                      onLoading: () async {
                        ...
                        if (logic.showFilteredProducts.isTrue) {
                          logic.fetchProductBasedOnFilters(context: context);
                        } else {
                          await categoryLogic.productFetchService(
                              context: context, id: widget.collectionID);
                        }
                      ...
                      child: GridView(
                        ...
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          childAspectRatio: AppConfig.to
                              .customizationProductImage["chooseImage"] ==
                              "square" ? 0.80 : 0.55,
