...
import 'package:tapify/src/modules/category/view_2.dart';
import 'package:tapify/src/modules/category/view_category_products.dart';
...
class _CategoryPageState extends State<CategoryPage>  with TickerProviderStateMixin, AutomaticKeepAliveClientMixin<CategoryPage> {
          ...
          child: SingleChildScrollView(
              ...
              child: Column(
                children: List.generate(
                  ...
                  final categoryItem = appConfig.collectionsWidgetsList
                      .value[index];
                        ...
                        onTap: (){
                          ...
                          if(categoryItem["items"].isEmpty) {
                            ...
                            Get.to(() =>  CategoryProducts(
                              categoryName:  categoryItem["name"] ?? "Un-named Category",
                              collectionID: "gid://shopify/Collection/${categoryItem["collectionId"]}",
                            ), transition: Transition.rightToLeft);


                          } else {
                            //----- Move to Sub Collection Page
                            Get.to(() => SubCategoriesPage(categoryIndex: index), transition: Transition.rightToLeft);
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                  child:
                                  Text(
                                      categoryItem["name"] ?? "Un-named Category",
