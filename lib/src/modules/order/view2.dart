...
class OrderDetialPage extends StatefulWidget {
  ...
  OrderDetialPage(
      {Key? key,
      this.orderDetailsMain,
      this.trackingStatusValue,
      this.trackingStatusURLValue})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            OrderDetailsScreen(
              orderDetails: widget.orderDetailsMain!,
              trackingStatus: widget.trackingStatusValue,
              trackingStatusURL: widget.trackingStatusURLValue,
            ),
            shippingAddressScreen(
              orderDetailsShipping: widget.orderDetailsMain,
            ),
            billingAddressScreen(
              orderDetailsBilling: widget.orderDetailsMain,
            ),
            paymentInformationScreen(
              orderDetailsPayment: widget.orderDetailsMain,
            )
          ],
        ),
      ),
