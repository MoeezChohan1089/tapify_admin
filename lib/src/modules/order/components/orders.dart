    ...
    print("bool value detail: ${widget.navigateToNext}");
      if (widget.navigateToNext == true) {
       Future.delayed(Duration(milliseconds: 250),(){
         Get.to(() => OrderDetialPage(orderDetailsMain: logic.userOrdersList.first,));
       });
      }else{
        null;
      }
  ...
  Widget build(BuildContext context) {
    return (LocalDatabase.to.box.read("customerAccessToken") != null)
      ...
      return SingleChildScrollView(
        child: ordersListLogic.userOrdersList.isNotEmpty ? Column(
          children: List.generate(
              ordersListLogic.userOrdersList.length, (index) {
                return GestureDetector(
                  onTap: () {
                    var successfulFulfillments = ordersListLogic.userOrdersList[index].successfulFulfillments;

                    if (successfulFulfillments != null && successfulFulfillments.isNotEmpty) {
                      var trackingStatus = successfulFulfillments[0].trackingInfo;
                      if (trackingStatus != null && trackingStatus.isNotEmpty) {
                        var trackingStatusValue = trackingStatus[0].number;
                        var trackingStatusURLValue = trackingStatus[0].url;

                        print("tracking no: $trackingStatusValue");

                        ordersListLogic.getOrdersService();
                        Get.to(() => OrderDetialPage(
                          orderDetailsMain: ordersListLogic.userOrdersList[index],
                          trackingStatusValue: trackingStatusValue,
                          trackingStatusURLValue: trackingStatusURLValue,
                        ));
                      }else{
                        ordersListLogic.getOrdersService();
                        Get.to(() => OrderDetialPage(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.memoryNetwork(
                              image: ordersListLogic.userOrdersList[index]
                                  .lineItems!.lineItemOrderList[0].variant?.image
                                  ?.originalSrc != null
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text("#${ordersListLogic
                                .userOrdersList[index].orderNumber}",
                            ...
                            SizedBox(
                              width: 150,
                              child: Text(ordersListLogic
                                  .userOrdersList[index].lineItems!
                                  .lineItemOrderList[0].title,
                                  maxLines: 1,
                            ...
                            Text(CurrencyController.to.getConvertedPrice(
                                priceAmount: ordersListLogic.userOrdersList[index]
                            ...
                            Text(
                              "Quantity: ${ordersListLogic.userOrdersList[index]
                                  .lineItems!.lineItemOrderList[0].quantity}",
                              style: context.text.bodySmall?.copyWith(
                                  color: AppColors.appHintColor),),
                          ],
                        ),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            16.heightBox,
                            Text("${ordersListLogic.userOrdersList[index]
                                .financialStatus}",
            ...
            children: [
              ...
              Text("No Order Placed!",
                style: context.text.labelMedium?.copyWith(
                    color: AppColors.appTextColor,
                    fontSize: 16.sp),),
              Text("Looks like you haven't place any order yet.",
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
              ...
              child: Text("Sign In", style: context.text.bodyMedium!.copyWith(
