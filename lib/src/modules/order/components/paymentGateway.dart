...
class paymentInformationScreen extends StatefulWidget {
  ...
  paymentInformationScreen({Key? key, this.orderDetailsPayment})
      : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Text(
                    CurrencyController.to.getConvertedPrice(
                        priceAmount: calculateTotalDiscount(widget
                                .orderDetailsPayment!
                                .lineItems!
                                .lineItemOrderList) ??
                            0),
            ...
            Row(
              children: [
                Text("Tax", style: context.text.bodyMedium),
                const Spacer(),
                Text(
                    CurrencyController.to.getConvertedPrice(
                        priceAmount: widget
                                .orderDetailsPayment?.totalTaxV2.amount
                                .toDouble() ??
                            0),
                    style: context.text.bodyMedium),
              ],
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    CurrencyController.to.getConvertedPrice(
                        priceAmount:
                            widget.orderDetailsPayment!.totalPriceV2.amount),
                    style: context.text.labelMedium?.copyWith(fontSize: 16.sp),
                  ),
                ],
              ),
