    ...
    return GetBuilder<CartLogic>(builder: (cartLogic) {
      ...
      return Column(
        ...
        children: List.generate(cartLogic.currentCart?.lineItems.length ?? 0,
          ...
          print(
              "product variants at index => $index is => ${item!.variant!.product!.productVariants.length}");
          ...
          print(
              "discounted price is ${item.variant?.compareAtPrice?.formattedPrice}");
            ...
            onTap: () {
              ...
              ProductSheet.to.productDetailBottomSheet(
                  ...
                  productInfo: ProductInfo(
                    ...
                    compareAtPrice: 0.0,
                    webUrl: "",
                    image: item.variant?.image?.originalSrc.isNotEmpty != null
                      ...
                      child: Stack(
                        children: [
                              ...
                              SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                      imageUrl:
                                          "${item.variant!.image!.originalSrc.split("?v=")[0]}?width=300}",
                                      fit: BoxFit.cover,
                          ...
                          Positioned(
                            bottom: 0,
                            right: 0,
                            child: item.variant?.availableForSale == false
                                ? Container(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () {
                                              print(
                                                  "current item quantity is ${item.quantity} :: and available quantity is ${item.variant!.quantityAvailable}");
                                                ...
                                                if (item.variant
                                                  ...
                                                  if (item.variant!
                                                    ...
                                                    if (item.quantity <
                                                      ...
                                                      showToastMessage(
                                                          message:
                                                              "Whoa! Currently ${item.variant!.quantityAvailable} available.");
                                                      cartLogic.isProcessing
                                                          .value = false;
                                                    }
                                                  } else {
                                                    cartLogic
