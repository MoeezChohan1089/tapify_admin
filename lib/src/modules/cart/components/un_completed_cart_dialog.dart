          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  height: CartLogic.to.currentCart!.lineItems.length == 1
                      ? 70.h
                      : CartLogic.to.currentCart!.lineItems.length == 2
                          ? 150.h
                          : CartLogic.to.currentCart!.lineItems.length == 3
                              ? 200.h
                              : 295.h,
                  child: SingleChildScrollView(
                    physics: CartLogic.to.currentCart!.lineItems.length < 4
                        ? const NeverScrollableScrollPhysics()
                        : null,
                    child: Column(
                      children: List.generate(
                          CartLogic.to.currentCart!.lineItems.length,
                          (index) => Padding(
