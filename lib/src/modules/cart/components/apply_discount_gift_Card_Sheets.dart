                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ///------ Image from Settings
                          isDiscountSheet ?
                          AppConfig.to.customizationDiscountCodePopUp["image"] != null ? Column(
                            children: [
                              ClipRRect(
                                ...
                                child: SizedBox(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: AppConfig.to.customizationDiscountCodePopUp["image"],
                                    fit: BoxFit.cover,
                              ...
                              : AppConfig.to.customizationCardGiftPopUp["image"] != null ? Column(
                            children: [
                              ClipRRect(
                                borderRadius: BorderRadius.circular(5.r),
                                child: SizedBox(
                                  ...
                                  width: 200.w,
                                  child: CachedNetworkImage(
                                    imageUrl: AppConfig.to.customizationCardGiftPopUp["image"],
                                    fit: BoxFit.cover,
                                    height: double.infinity,
                                    width: double.infinity,
                                    progressIndicatorBuilder:
                          ...
                          isDiscountSheet ?
                          AppConfig.to.customizationDiscountCodePopUp["cardGiftMessage"] != null ? Column(
                            children: [
                              Text("${AppConfig.to.customizationDiscountCodePopUp["cardGiftMessage"]}"),
                              20.heightBox,
                            ],
                          ) : const SizedBox.shrink()
                              : AppConfig.to.customizationCardGiftPopUp["cardGiftMessage"] != null ? Column(
                            children: [
                              Text("${AppConfig.to.customizationCardGiftPopUp["cardGiftMessage"]}"),
                              20.heightBox,
                            ],
                          ) : const SizedBox.shrink(),
                          ...
                          CustomTextField(
                            controller: isDiscountSheet ? cartLogic
                                .discountCodeTextController : cartLogic
                                .giftCardTextController,
