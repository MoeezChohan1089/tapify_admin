  ...
  Widget build(BuildContext context) {
    return GetBuilder<CartLogic>(builder: (cartLogic) {
      return (cartLogic.currentCart != null &&
          cartLogic.currentCart!.lineItems.isNotEmpty) ? InkWell(
        onTap: () {},
        child: SafeArea(
          child: Column(
              ...
              Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        ...
                        offset: const Offset(0, -3), // Negative offset to position the shadow on top
                        blurRadius: 7,
                        spreadRadius: 0,
                      ),
                      const BoxShadow(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppConfig.to.appSettingsCartAndCheckout["checkoutNotes"] == true ?  GestureDetector(
                        onTap: () {
                      ...
                      cartLogic.currentCart!.appliedGiftCards.isEmpty
                        ...
                        children: [
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: List.generate(
                                            cartLogic.currentCart!.appliedGiftCards
                                                .length, (index) {
                                          return
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          "....${cartLogic
                                                              .currentCart!
                                                              .appliedGiftCards[index]
                                                              .last4Digits.toString()
                                                              .toUpperCase()}",
                                                          style: context.text
                                                              .bodySmall?.copyWith(
                                                              height: 0.5,
                          ...
                          Text("-\$${cartLogic.totalGiftCardAmountApplied}",
                            style: context.text.bodyMedium,
                          ),
                        ],
                      ),
                      ...
                      cartLogic.totalDiscountApplied == 0
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Expanded(
                                    child: SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: List.generate(
                                            cartLogic.discountCodesAdded.length, (
                                            index) {
                                          return
                                            Padding(
                                                padding: EdgeInsets.only(
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                            ...
                                                            cartLogic.getCodeFromDiscountList(cartLogic.discountCodesAdded[index]),
                                                            // (cartLogic.discountCodesAdded[index] == HomeLogic.to.widgetShopifyCode.value) ? HomeLogic.to.widgetCustomerCode.value.toString().toUpperCase() :   cartLogic
                                                            //     .discountCodesAdded[index]
                                                            //     .toString()
                                                            //     .toUpperCase(),
                                                            style: context.text
                                                                .bodySmall
                          ...
                          Text("-\$${cartLogic.totalDiscountApplied}",
                            style: context.text.bodyMedium,
                          ),
                        ],
                      ),
