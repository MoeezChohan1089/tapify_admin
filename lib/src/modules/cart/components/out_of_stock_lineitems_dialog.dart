...
outOfStockCartItemsDialog(
    ...
    required List<LineItem> outOfStockLineItems,
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Whoops, You missed it",
                    style: context.text.labelMedium?.copyWith(fontSize: 18.sp)),
                5.heightBox,
                Padding(
                  ...
                  child: Text(
                    ...
                    style: context.text.bodyMedium!
                        .copyWith(color: AppColors.appHintColor, height: 1.2),
                  ),
                ),
                16.heightBox,

                SizedBox(
                  height: outOfStockLineItems.length == 1
                      ? 70.h
                      : outOfStockLineItems.length == 2
                          ? 150.h
                          : outOfStockLineItems.length == 3
                              ? 200.h
                              : 295.h,
                  child: SingleChildScrollView(
                    physics: outOfStockLineItems.length < 4
                        ? const NeverScrollableScrollPhysics()
                        : null,
                    child: Column(
                      children: List.generate(
                          outOfStockLineItems.length,
                          (index) => Padding(
                                padding: EdgeInsets.only(
                                    bottom: 17.h, right: 10.w, left: 10.w),
                                child: Row(
                                  children: [
                                    SizedBox(
                                      width: 55.h,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: outOfStockLineItems[index]
                                                  .variant
                                                  ?.image!
                                                  .originalSrc ??
                                              "",
                                            ...
                                            children: [
                                              ...
                                              outOfStockLineItems[index]
                                                  ...
                                                  ? Text(
                                                      CurrencyController.to
                                                          .getConvertedPrice(
                                                              priceAmount: outOfStockLineItems[
                                                                          index]
                                                                      .variant
                                                                      ?.compareAtPrice
                                                                      ?.amount ??
