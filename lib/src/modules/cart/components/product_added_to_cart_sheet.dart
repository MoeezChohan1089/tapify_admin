...
productAddedbottomSheet(BuildContext context, selectedImageUrl, vendor, title, price, comparePrice) {
                ...
                child: SafeArea(
                    child: Column(
                      children: [
                        ...
                        logic.quickBottomSheet.value == 'cart'? GlobalElevatedButton(
                          text: "Done",
                          onPressed: () {
