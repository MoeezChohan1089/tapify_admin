  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        ...
        trailingButton: (logic.currentCart != null &&
                logic.currentCart!.lineItems.isNotEmpty)
            ? TextButton(
                onPressed: () async {
                ...
                child: Text(
                  ...
                  style: context.text.bodyMedium?.copyWith(
                      color:
                          AppConfig.to.appbarBGColor.value == Color(0xffFF0000)
                              ? AppConfig.to.iconCollectionColor.value
                              : Colors.red),
                ),
              )
      ...
      body: GetBuilder<CartLogic>(builder: (cartLogic) {
        ...
        return (cartLogic.currentCart != null &&
            ...
            ? cartLogic.loadingAnimation.isTrue
                ? Center(
      ...
      bottomNavigationBar: GetBuilder<CartLogic>(builder: (cartLogic) {
        return cartLogic.loadingAnimation.isTrue
            ? const SizedBox.shrink()
            : SlideInUp(
                duration: const Duration(milliseconds: 500),
