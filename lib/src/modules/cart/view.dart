  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        ...
        trailingButton: (logic.currentCart != null && logic.currentCart!.lineItems.isNotEmpty) ? TextButton(
          onPressed: () async {
          ...
          child: Text('Clear Cart',
            style: context.text.bodyMedium?.copyWith(
                color: AppConfig.to.appbarBGColor.value == Color(0xffFF0000)? AppConfig.to.iconCollectionColor.value: Colors.red
            ),
          ),
