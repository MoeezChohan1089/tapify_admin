...
class _AuthPageState extends State<AuthPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            children: [
              Container(
                ...
                child: TabBar(
                  ...
                  labelStyle:
                      context.text.labelSmall?.copyWith(fontSize: 16.sp),
                  dividerColor: Colors.white,
                  // splashBorderRadius: BorderRadius.circular(8.r),
                  labelPadding:
                      EdgeInsets.only(bottom: 7.h, right: 10, left: 16),
      ...
      bottomNavigationBar: (CartLogic.to.getAccCreationSetting
              .contains("Required"))
              ...
              child: Wrap(
                children: [
                  Center(
                    child: Padding(
                      padding:
                          EdgeInsets.symmetric(vertical: pageMarginVertical),
