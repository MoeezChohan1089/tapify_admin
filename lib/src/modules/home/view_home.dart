...
import 'components/demovideo2.dart';
...
class _HomePageState extends State<HomePage>
            ...
            child: Column(
              ...
              List.generate(
                AppConfig.to.homeWidgetsList.value.length,
                    (index) {
                  return _buildWidget(AppConfig.to.homeWidgetsList.value[index]);
                    }
              ),
  ...
  Widget _buildWidget(Map<String, dynamic> widgetData) {
    ...
    final widgetMap = {
      ...
      'video': () =>
          SingleVideoView2(settings: settings,),
      ...
      'discount': () {
        ...
        logic.addUpdateCodesList(settings);
      ...
      'productByTags': () {
        ...
        logic.getProducts(isFromHome: true);
        return (settings["metadata"]["data"] as List).isEmpty ? const SizedBox
