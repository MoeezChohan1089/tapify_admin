...
class _CountDownTimerState extends State<CountDownTimer> {
  ...
  void initState() {
    ...
    (widget.settings['startDate'] != 0 &&
        ...
        ? HomeLogic.to.calculationFun(widget.settings)
        : 0;
  }
      ...
      return (allZero)
          ...
          : GestureDetector(
              ...
              onTap: () {
                ...
                if (widget.settings['disableInteraction'] == false &&
                    widget.settings['metadata']['data'].isNotEmpty) {
                  ...
                  children: [
                                  ...
                                  child: Text(
                                    ...
                                    textAlign: widget
                                        ...
                                        : widget.settings['titleAlignment'] ==
                                            ...
                                            ? TextAlign.center
                                            : TextAlign.end,
                                    style: widget.settings['titleSize'] ==
                                            "small"
                    ...
                    Padding(
                      padding: widget.settings['margin'] == true
                          ...
                          : EdgeInsets.only(left: 6, top: 16, right: 6),
                      child: Column(
                        children: [
          ...
          Padding(
            padding: widget.settings['margin'] == true
                ...
                : widget.settings['contentMargin'] == true
                    ? EdgeInsets.only(
                        top: pageMarginVertical, bottom: pageMarginVertical - 6)
                    : EdgeInsets.zero,
            child: Container(
              width: double.maxFinite,
                  ...
                  children: [
                    ...
                    Positioned.fill(
                      child: Container(
                        ...
                        // height: 400,
                        decoration: BoxDecoration(
                          color: widget.settings['titlePosition'] == "center"
