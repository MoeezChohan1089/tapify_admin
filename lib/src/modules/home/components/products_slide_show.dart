  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return appConfig.innerLoader.value == true
          ? ShimerRectSliderPage()
          : Padding(
              padding: settings['margin'] == true
                  ? EdgeInsets.only(
                      top: pageMarginHorizontal / 1.5,
                      bottom: pageMarginHorizontal / 1.5,
              ...
              child: Column(
                children: [
                  ...
                  (settings["isTitleHidden"] == false)
                      ...
                      : const SizedBox(),
                  Padding(
                    padding: settings['contentMargin'] == true
                    ...
                    child: SizedBox(
                      ...
                      child: Stack(
                        ...
                        children: [
                          CarouselSlider(
                            items: List.generate(
                                settings["metadata"]["data"].length, (index) {
                              final indexData =
                                  settings["metadata"]["data"][index];

                              ProductInfo? productInfo =
                                  appConfig.getProductById(
                                id: indexData["id"],
                          ...
                          Positioned(
                            bottom: settings['margin'] == true
                                ? pageMarginVertical
                                : pageMarginVertical,
                            child: settings['titlePosition'] == 'center' ||
                                    settings['titlePosition'] == 'hidden'
                                ? Row(
