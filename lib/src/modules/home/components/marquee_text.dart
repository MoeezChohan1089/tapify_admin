...
class AnimatedMarqueeText extends StatelessWidget {
  ...
  const AnimatedMarqueeText({Key? key, required this.settings})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      height: settings["titleSize"] == "small"
          ? 45.h
          : (settings["titleSize"] == "medium" ? 50.h : 55.h),
      ...
      child: Align(
        ...
        child: Material(
          ...
          child: Marquee(
            ...
            blankSpace: 100.w,
            // velocity: 50.0,
            velocity: settings["titleSpeed"] == "slow"
                ? 50.0
                : settings["titleSpeed"] == "medium"
                    ? 90.0
                    : 120.0,
            startPadding: 10.0,
