...
import 'package:tapify_admin/src/utils/home_widgets_stylings.dart';
                      ...
                      return Column(
                        children: [
                          GestureDetector(
                            ...
                            child: Padding(
                              padding:EdgeInsets.only(
                                  right: index ==  widget.settings["metadata"]["data"].length -1 ? 0 : widget.settings['contentMargin'] != true ? pageMarginHorizontal : pageMarginHorizontal * 2),
                              child: Stack(
                                children: [
                                  ClipRRect(
