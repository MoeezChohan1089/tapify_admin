...
class _ProductsCarouselState extends State<ProductsCarousel> {
  ...
  double getHeight(String str) {
    final heightMap = {
      'normal-small': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 250.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 260.h : 290.h,
      'normal-medium': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 270.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 280.h : 310.h,
      // 'normal-medium': 310.h,
      'normal-large': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 330.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 340.h : 370.h,
      // 'normal-large': 370.h,
      'horizontal-small': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 180.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 190.h : 220.h,
      // 'horizontal-small': 220.h,
      'horizontal-medium': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 200.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 210.h : 240.h,
      // 'horizontal-medium': 240.h,
      'horizontal-large': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 240.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 250.h : 280.h,
      // 'horizontal-large': 280.h,
      'vertical-small': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 320.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 330.h : 360.h,
      // 'vertical-small': 360.h,
      'vertical-medium': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 360.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 370.h : 400.h,
      // 'vertical-medium': 400.h,
      'vertical-large': (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"]) ? 390.h : (widget.settings["hideContentPrice"] || widget.settings["hideContentTitle"]) ? 400.h : 430.h,
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              // color: Colors.green,
                              margin: EdgeInsets.symmetric(horizontal: widget.settings["contentMargin"] == true ?  12.0 : 3.0),
                              child: ClipRRect(
                          ...
                          (widget.settings["hideContentPrice"] && widget.settings["hideContentTitle"])   ?  const SizedBox.shrink() :      Obx(() {
                            return HomeLogic.to.currentCarouselIndex.value == itemIndex
                                ? Column(
                              children: [
