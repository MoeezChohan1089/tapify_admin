...
class _CategoryListState extends State<CategoryList> {
  ...
  customBoxCategory(String src){
    return Container(
      height: 118.h,
      width: 101.w,
      padding: EdgeInsets.symmetric(vertical: pageMarginHorizontal, horizontal: pageMarginHorizontal),
      decoration: BoxDecoration(
          border: Border.all(color: AppColors.customIconColor),
          borderRadius: BorderRadius.circular(6)
      ),
      child: Image.network(src, width: 47,),
    );
  }
         ...
         widget.settings['isTitleHidden'] == true? Container(
          ...
          SingleChildScrollView(
            ...
            padding: EdgeInsets.only(
              left: widget.settings['margin'] == true? pageMarginHorizontal * 2:pageMarginHorizontal, top: widget.settings['margin'] == true? pageMarginVertical * 2:pageMarginVertical,
            ),
            child: Row(
              children: List.generate(5, (index) => GestureDetector(
                ...
                child: Container(
                  margin: EdgeInsets.only(
                      right: widget.settings['contentMargin'] == true? pageMarginHorizontal + 18.w:pageMarginHorizontal + 8.w
                  ),
                  // width: 90,
                  child: Column(
                    // crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      customBoxCategory('https://pngimg.com/uploads/dress/dress_PNG75.png'),
                     widget.settings['hideContentTitle'] == true? 10.heightBox:SizedBox(),
                      widget.settings['hideContentTitle'] == true? SizedBox(
                        width: 80,
                        // color: Colors.red,
                        child: Text('Women',
