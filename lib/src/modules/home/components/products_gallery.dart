  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
          vertical: settings['margin'] == true
              ? pageMarginVertical * 1.5
              : pageMarginVertical),
      child: Column(
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Row(
                            ...
                            children: List.generate(
                              ...
                              return (settings["metadata"]['productType'] ==
                                          "automatic" &&
                                      settings["metadata"]['dataType'] !=
                                          "web-url")
                                  ? index < settings["metadata"]["data"].length
                                      ? GestureDetector(
                                          onTap: () {
                                            if (settings[
                                                    'disableInteraction'] ==
                                                      ...
                                                      child: Text(
                                                        (settings["metadata"][
                                                                ...
                                                                settings["metadata"]
                                                                        ...
                                                                        'productType'] ==
                                                                    "automatic")
                                                            ? "View All\n${settings['metadata']['automaticProducts']['collection']['title']}"
                                                            : "View All\n Collections",
                                                        textAlign:
                                                            TextAlign.center,
                                                      ),
