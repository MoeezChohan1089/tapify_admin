      ...
      return appConfig.isLoading.isTrue
          ...
          : Padding(
              padding: widget.settings['margin'] == true
                  ...
                  : EdgeInsets.only(
                      top: pageMarginVertical, bottom: pageMarginVertical / 2),
              child: Column(
                  ...
                  SingleChildScrollView(
                    ...
                    padding: EdgeInsets.only(
                      left: widget.settings['margin'] == true
                          ? pageMarginHorizontal * 2
                          : pageMarginHorizontal,
                      bottom: widget.settings["hideContentTitle"] == true
                          ? 14.h
                          : 0.h,
                    ),
                    child: Row(
                      ...
                      children: List.generate(
                        ...
                        return (widget.settings["metadata"]['productType'] ==
                                ...
                                widget.settings["metadata"]['dataType'] !=
                                    "web-url")
                            ? index < widget.settings["metadata"]["data"].length
                                                ...
                                                child: Text(
                                                  (widget.settings["metadata"][
                                                          ...
                                                          widget.settings[
                                                                  ...
                                                                  'productType'] ==
                                                              "automatic")
                                                      ? "View All\n${widget.settings['metadata']['automaticProducts']['collection']['title']}"
                                                      : "View All\n Collections",
                            ...
                            : productInfo != null && appConfig.isLoading.isFalse
                                ? Container(
                                    margin: EdgeInsets.only(
                                        right:
                                            widget.settings['contentMargin'] ==
