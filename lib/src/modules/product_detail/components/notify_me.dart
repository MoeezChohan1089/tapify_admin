...
import 'package:tapify_admin/src/modules/product_detail/components/bottom_sheet_notify_me.dart';
...
class NotifyMeSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Visibility(
        visible: logic.product == null
            ? false
            : logic.listOfOptions.isEmpty
                ? logic.product!.availableForSale == true
                    ? false
                    : true
                : logic
                            .product
                            ?.productVariants[logic.selectedVariantIndex.value]
                            .availableForSale ==
                        true
                    ? false
                    : true,
