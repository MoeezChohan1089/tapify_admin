...
class _RecommendedProductsState extends State<RecommendedProducts> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductDetailLogic>(
      assignId: true,
      builder: (logic) {
        return logic.recommendedProducts.value.isNotEmpty
            ? Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            print(
                                "value of ID in recommended====>${logic.product!.collectionList![0].id}");
                            Get.to(() => CategoryProducts(
                                  collectionID:
                                      logic.product!.collectionList![0].id,
                                  categoryName:
                                      logic.product!.collectionList![0].title,
                                ));
                          },
                          child: Text(
                            'View All',
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                          logic.recommendedProducts.value.length, (index) {
                        return logic.product?.id ==
                                logic.recommendedProducts.value[index].id
                            ? SizedBox()
                            : Container(
                                height: 270.h,
                                ...
                                child: CustomProductCard(
                                  product:
                                      logic.recommendedProducts.value[index],
                                ),
                              );
