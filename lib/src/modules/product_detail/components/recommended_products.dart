...
import 'package:tapify_admin/src/modules/cart/components/discountCodeDialogue.dart';
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: (){
                      ...
                      Get.to(() => CategoryProducts(collectionID: logic.product!.collectionList![0].id, categoryName: logic.product!.collectionList![0].title,), transition: Transition.native, opaque: false,);
                    },
                    child: Text(
                      'View All',
