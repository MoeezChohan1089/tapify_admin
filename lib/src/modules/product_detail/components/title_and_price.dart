      ...
      return logic.productDetailLoader.value == true
          ...
          : Padding(
              padding: EdgeInsets.only(
                ...
                top: logic.product?.images.length == 1
                    ? pageMarginVertical
                                        ...
                                        : Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                4.widthBox,
                                                Text(
                                                    '(${logic.productReviews.value['review_count']})',
                                                    style: context
                                                        .text.bodyMedium
                                                        ?.copyWith(
                                                            height: 0.1,
                      ...
                      Obx(() {
                        ...
                        return GestureDetector(
                          onTap: () => WishlistLogic.to.addOrRemoveBookmark(
                              context: context, product: logic.product!),
