...
class VariantsSelector extends StatefulWidget {
  ...
  @override
  State<VariantsSelector> createState() => _VariantsSelectorState();
}
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                            "${logic.listOfOptions[index]['name']}",
                                                ...
                                                child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        color: AppColors
                                                            .textFieldBGColor,
                                                        border: Border.all(
                                                            color: logic.listOfOptions[index]
                                                                            ['sub_options']
                                                                        [index2][
                                                                    'is_selected']
                                                                ? AppConfig
                                                        ...
                                                        borderRadius:
                                                            BorderRadius.circular(
                                                                3.r)),
                                                    child: Text(logic.listOfOptions[index]['sub_options'][index2]['name'].toString().capitalize!,
                                                        style: context.text.bodyMedium?.copyWith(
                                                          height: 0.5,
                                                          color: logic.listOfOptions[
                                                                          index]
                                                                      [
                                                                      'sub_options'][index2]
                                                                  [
