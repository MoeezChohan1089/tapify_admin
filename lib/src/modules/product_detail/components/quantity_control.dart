...
class QuantityControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return productLogic.productDetailLoader.value == true
          ? ShimertitlePage()
          : productLogic
                      .product
                      ?.productVariants[productLogic.selectedVariantIndex.value]
                      .availableForSale ==
                  false
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                (productLogic.productDetailLoader.isTrue &&
                                        productLogic
                                                .product!
                                        ...
                                        (productLogic
                                            ...
                                            productLogic
                                                ...
                                                10))
                                    ? Text(
                                        "Only ${productLogic.product!.productVariants[productLogic.selectedVariantIndex.value].quantityAvailable} left",
                                                    ...
                                                    productLogic
                                                        ...
                                                        .productVariants[
                                                            productLogic
                                                                ...
                                                                .value]
                                                        .quantityAvailable) {
                                                  productLogic.productQuantity
                                                      .value += 1;
                                                  HapticFeedback.lightImpact();
                                                } else {
                                                  showToastMessage(
                                                      message:
                                                          "Whoa! Currently ${productLogic.product!.productVariants[productLogic.selectedVariantIndex.value].quantityAvailable} available.");
                                                }
                                              } else {
                                                productLogic
                                                    .productQuantity.value += 1;
